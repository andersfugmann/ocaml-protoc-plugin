  ...
  module rec Protobuf : sig
    ...
    module rec Compiler : sig
      ...
      module rec Version : sig
        ...
        let to_proto' =
          let spec = Runtime'.Spec.( basic_opt ((1, "major", "major"), int32_int) ^:: basic_opt ((2, "minor", "minor"), int32_int) ^:: basic_opt ((3, "patch", "patch"), int32_int) ^:: basic_opt ((4, "suffix", "suffix"), string) ^:: nil ) in
      ...
      and CodeGeneratorResponse : sig
        ...
        and File : sig
          ...
          let to_proto' =
            let spec = Runtime'.Spec.( basic_opt ((1, "name", "name"), string) ^:: basic_opt ((2, "insertion_point", "insertionPoint"), string) ^:: basic_opt ((15, "content", "content"), string) ^:: basic_opt ((16, "generated_code_info", "generatedCodeInfo"), (message (module Imported'modules.Descriptor.Google.Protobuf.GeneratedCodeInfo))) ^:: nil ) in
            let serialize = Runtime'.Serialize.serialize spec in
        ...
        let to_proto' =
          let spec = Runtime'.Spec.( basic_opt ((1, "error", "error"), string) ^:: basic_opt ((2, "supported_features", "supportedFeatures"), uint64_int) ^:: repeated ((15, "file", "file"), (message (module File)), not_packed) ^:: nil ) in
          let serialize = Runtime'.Serialize.serialize spec in
