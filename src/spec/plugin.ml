  ...
  module rec Protobuf : sig
    ...
    module rec Compiler : sig
      ...
      module rec Version : sig
        ...
        let merge = (fun t1 t2 -> {
          major = (Runtime'.Merge.merge Runtime'.Deserialize.C.( basic_opt ((1, "major", "major"), int32_int) ) t1.major t2.major);
          minor = (Runtime'.Merge.merge Runtime'.Deserialize.C.( basic_opt ((2, "minor", "minor"), int32_int) ) t1.minor t2.minor);
          patch = (Runtime'.Merge.merge Runtime'.Deserialize.C.( basic_opt ((3, "patch", "patch"), int32_int) ) t1.patch t2.patch);
          suffix = (Runtime'.Merge.merge Runtime'.Deserialize.C.( basic_opt ((4, "suffix", "suffix"), string) ) t1.suffix t2.suffix);
           })
        let to_proto' =
          let spec = Runtime'.Serialize.C.( basic_opt ((1, "major", "major"), int32_int) ^:: basic_opt ((2, "minor", "minor"), int32_int) ^:: basic_opt ((3, "patch", "patch"), int32_int) ^:: basic_opt ((4, "suffix", "suffix"), string) ^:: nil ) in
        ...
        let from_proto_exn =
          ...
          let spec = Runtime'.Deserialize.C.( basic_opt ((1, "major", "major"), int32_int) ^:: basic_opt ((2, "minor", "minor"), int32_int) ^:: basic_opt ((3, "patch", "patch"), int32_int) ^:: basic_opt ((4, "suffix", "suffix"), string) ^:: nil ) in
